...
const Index = () => {
  ...
  return (
    <>
      ...
      {/* <!-- About Text Content --> */}
      <div className="about-section" style={{ background: "" }}>
        ...
        <div className="row">
          <div className="col-lg-12">
            ...
            >
              <h2 className="text-light"><span style={{ color: "#2e008b" }}>Appraisal</span> <span style={{ color: "#97d808" }}>Land</span> works</h2>
            </div>
          </div>
        </div>
        {/* End .row */}
          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="search_smart_property text-center">
                ...
                <Land href="/sign-up" className="my_profile_setting_input">
